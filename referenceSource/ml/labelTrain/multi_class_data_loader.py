...
class MultiClassDataLoader(object):
    ...
    def define_flags(self):
        self.__flags.DEFINE_string("train_data_file", "C:/projectWork/labelTrain/data/kkk.train", "Data source for the training data.")
        self.__flags.DEFINE_string("dev_data_file", "C:/projectWork/labelTrain/data/kkk.dev", "Data source for the cross validation data.")
        self.__flags.DEFINE_string("class_data_file", "C:/projectWork/labelTrain/data/kkk.cls", "Data source for the class list.")
    ...
    def load_dev_data_and_labels_json(self, ocrData):
        self.__resolve_params()
        x_dev, y_dev = self.__load_data_and_labels_json(ocrData)
        return [x_dev, y_dev]
    ...
    def __load_data_and_labels_json(self, ocrData):
        try:
            x_text = []
            y = []
            classes = self.__classes()
